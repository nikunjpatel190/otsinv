...
echo form_open('c=product', $attributes); 
?>
...
<div class="row-fluid">
    ...
    <div class="span6 text-right">     
 		<select class="required span6" name="slt_category" id="slt_category" >
        	<?php echo $this->Page->generateComboByTable("product_category","cat_id","cat_name","","where status='ACTIVE'",$cat_id,"Select Category"); ?>
        </select>
