...
echo form_open('c=setting&m=savePanel', $attributes);
?>
...
<input type="hidden" name="panel_id" value="<?php echo $id; ?>" id="panel_id" />
    ...
    <div class="span10">
        <fieldset>
            <div class="control-group">
                <label for="form-field-1" class="control-label">Panel Name <span class="red">*</span></label>
                <div class="controls">
                    <input type="text" id="txt_panel_name" name="txt_panel_name" class="required span6" value="<?php echo $rsEdit->panel_name; ?>" />
                </div>
            </div>
            ...
            <div class="control-group">
                <label for="form-field-1" class="control-label">Image Url<span class="red">*</span></label>
                <div class="controls">
                    <input type="text" id="txt_img_url" name="txt_img_url" class="span6 required" value="<?php echo $rsEdit->img_url; ?>" />
                </div>
            </div>
